import 'package:app0/kids/categories/young%20girl/list_constractor.dart'; // Importing the list constructor for young girl products
...
// A widget representing the YoungGirl category page
...
class YoungGirlState extends State<YoungGirl> {
  ...
  Widget build(BuildContext context) {
    // Building the UI for the Young Girls category page
    return SafeArea(
        child: Scaffold(
      body: YoungGirlList(), // Displaying the YoungGirlList widget
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Young Girls Section', // Setting the title of the AppBar
